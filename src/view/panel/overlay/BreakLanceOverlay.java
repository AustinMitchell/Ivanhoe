...
public class BreakLanceOverlay extends OverlayPanel {
	private CardDisplayPanel[] display;
	
	public BreakLanceOverlay(DescriptionBox descriptionBox, GameState game, int realPlayerIndex, CardDisplayPanel[] gameDisplay) {
		super("Break Lance - Select Opponent...", descriptionBox, game, realPlayerIndex);
		
		removeWidget(title);
		addWidget(title, 0, 0, 100, 100);
		
		ArrayList<Boolean> validPlayers = Validator.validateBreakLance(game);
